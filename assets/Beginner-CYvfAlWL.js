import{j as e,r as o,_ as p,C as a}from"./index-BWpAP3gJ.js";import"./services-CQQVyGs2.js";const f=[{text:"One of my most productive days was throwing away 1000 lines of code.",author:"Ken Thompson",bio:"Designer of Unix Operating System"},{text:"A ship in port is safe, but that's not what ships are built for.",author:"Admiral Grace Hopper",bio:"Inventor of Programming Compilers"},{text:"If you optimize everything, you will always be unhappy.",author:"Donald Knuth",bio:"Pioneer of Algorithm Analysis"}],I=({text:t,author:s,bio:n})=>e.jsxs("div",{className:"w-[20rem] flex flex-col",children:[e.jsx("div",{className:`
		...
		${n}
	`,children:t})},U=()=>e.jsxs(e.Fragment,{children:[e.jsx(N,{}),e.jsx(N,{large:!0,children:"Button 2"})]}),j=[{name:"Winnifred",age:10,breed:"Scottish Fold",location:"Queens, NY",imageUrl:"https://static-task-assets.react-formula.com/378212.jpg"},{name:"Abby",age:4,breed:"Abysinnian",location:"Charleston, WV",imageUrl:"https://static-task-assets.react-formula.com/470756.jpg"},{name:"Simon",age:2,breed:"Siamese",location:"Seattle, WA",imageUrl:"https://static-task-assets.react-formula.com/130714.jpg"},{name:"Marcus",age:5,breed:"Maine Coon",location:"Bar Harbor, ME",imageUrl:"https://static-task-assets.react-formula.com/010338.jpg"},{name:"Penelope",age:6,breed:"Persian",location:"Tuscon, AZ",imageUrl:"https://static-task-assets.react-formula.com/774965.jpg"}],u=({children:t,label:s,text:n})=>e.jsxs("div",{className:"flex flex-row text-neutral-500",children:[e.jsx("div",{className:"mr-2 font-bold w-full max-w-24",children:s}),e.jsx("div",{children:n})]}),$=({children:t,cat:s})=>e.jsxs("div",{className:"flex flex-col border border-neutral-600 rounded-lg mx-4",children:[e.jsx("div",{children:e.jsx("img",{className:"w-80 h-64 object-cover rounded-t-lg",src:s.imageUrl})}),e.jsxs("div",{className:"p-4",children:[e.jsx(u,{label:"Name",text:s.name}),e.jsx(u,{label:"Age",text:s.age}),e.jsx(u,{label:"Breed",text:s.breed}),e.jsx(u,{label:"Location",text:s.location})]})]}),w=({children:t,onClick:s,visible:n=!0})=>e.jsx("button",{className:`font-noto text-4xl ${n?null:"invisible"}`,onClick:s,children:t}),C=t=>t>=j.length?j.length-1:t<0?0:t,M=()=>{const[t,s]=o.useState(0);return e.jsxs("div",{className:"h-full flex flex-col justify-start items-center",children:[e.jsx("h1",{className:"mb-4 text-4xl",children:"Cat Carousel"}),e.jsxs("div",{className:"flex flex-row",children:[t>0?e.jsx(w,{onClick:n=>s(C(t-1)),children:"⬅"}):null,e.jsx($,{cat:j[t]}),e.jsx(w,{onClick:n=>s(C(t+1)),visible:t<j.length-1,children:"➡"})]})]})},b="m-2 px-4 text-white rounded-md",P=()=>{const[t,s]=o.useState("user friendly was here!");return e.jsxs("div",{className:"h-full flex flex-col items-center justify-center",children:[e.jsx("div",{className:"text-3xl text-stone-400",children:t}),e.jsxs("div",{className:"flex mt-4",children:[e.jsx("button",{onClick:n=>s("bye!"),className:b+" bg-green-400",children:"One"}),e.jsx("button",{onClick:n=>s("yay!"),className:b+" bg-red-400",children:"Two"}),e.jsx("button",{onClick:n=>s("woooo!"),className:b+" bg-violet-400",children:"Three"})]})]})},L=()=>{const[t,s]=o.useState(!1);return e.jsxs("div",{className:`
		bg-green-100 border border-green-300 p-4 rounded-lg m-4 text-center
		flex flex-col items-center
	`,children:[e.jsx("button",{onClick:n=>s(!t),className:"px-4 py-2 bg-teal-500 text-white rounded-full",children:"click me"}),t?e.jsx("span",{className:"text-4xl mt-4",children:"🙃"}):null]})},W=()=>{const[t,s]=o.useState(!1),n=c=>{setTimeout(()=>s(!t),2e3)};return e.jsx("div",{className:`
		bg-sky-100 border border-green-300 p-4 rounded-lg m-4 text-center
		flex flex-col items-center
	`,children:e.jsx("button",{onClick:n,className:`px-4 py-2 ${t?"bg-orange-500":"bg-blue-500"} text-white rounded-full`,children:"click me"})})},R=()=>{const[t,s]=o.useState(!1);return e.jsxs("div",{className:`
		bg-purple-100 border border-green-300 p-4 rounded-lg m-4 text-center
		flex flex-col items-center
	`,children:[e.jsx("span",{className:`text-4xl mb-4 ${!t&&"invisible"}`,children:"💩"}),e.jsx("button",{onClick:n=>s(!t),className:"px-4 py-2 bg-fuchsia-500 text-white rounded-full",children:"click me"})]})},z=()=>e.jsxs("div",{className:"h-full flex flex-col flex justify-start items-center gap-y-4 font-noto",children:[e.jsx(L,{}),e.jsx(W,{}),e.jsx(R,{})]}),Q=2,y=1,E=16,m=1,H=1e3,O={n:0,d:m,tId:null},F=t=>{const s=Q**t.d;return t.d<E&&(t.d+=1),parseInt(s*y)},k=(t,s=!1)=>(s?t.n+=F(t):t.n+=y,p.create({},t)),S=(t,s=!1)=>(s?t.n-=F(t):t.n-=y,p.create({},t)),K=()=>{const[t,s]=o.useState(O);o.useEffect(()=>(t.d>m?t.tId=setTimeout(()=>{console.log(`reset delta to: ${m}`),t.d=m,s(p.create({},t))},H):console.log("delta is unchanged"),()=>{t.tId&&(console.log("cancel timeout"),clearTimeout(t.tId))}),[t]);const n=(t.d-1)/(E-1);return e.jsxs("div",{className:"h-full flex flex-col justify-center items-center text-3xl font-noto",children:[e.jsx("span",{className:"p-4 mb-4 rounded-xl text-black text-6xl text-center",style:{backgroundColor:`rgba(239, 68, 68, ${n})`},children:t.n}),e.jsxs("div",{className:"flex flex-row justify-center items-center gap-x-8",children:[e.jsx("button",{onClick:c=>s(S(t,!0)),className:"p-4 bg-red-300 text-white rounded-lg",children:"➖➖"}),e.jsx("button",{onClick:c=>s(S(t)),className:"p-4 bg-red-400 text-white rounded-lg",children:"➖"}),e.jsx("button",{onClick:c=>s(k(t)),className:"p-4 bg-green-400 text-white rounded-lg",children:"➕"}),e.jsx("button",{onClick:c=>s(k(t,!0)),className:"p-4 bg-green-300 text-white rounded-lg",children:"➕➕"})]})]})},V="🐈",r=()=>e.jsx("div",{className:"p-2 border-2 rounded-lg border-amber-400",children:e.jsx("span",{className:"fa-solid fa-cat text-2xl text-amber-400",children:V})}),x=({children:t})=>e.jsx("span",{className:"absolute top-0 left-2 text-slate-200 text-xs",children:t}),Y=()=>e.jsxs(e.Fragment,{children:[e.jsx("h2",{className:"text-4xl flex justify-center",children:"Flex Exercise"}),e.jsxs("div",{className:"font-noto",children:[e.jsxs("div",{className:`flex h-64 p-4 m-4 border-2 border-blue-400 relative
	  	justify-center
...
`,d=({children:t,route:s,type:n="button",style:c=ee,onClick:v=i=>{}})=>s===void 0?e.jsx("button",{type:n,onClick:i=>v(i,s),className:c,children:t}):e.jsx("a",{href:s,onClick:i=>{i.preventDefault(),v(i,s)},className:c,children:t}),te="🕵️",g="select-none cursor-pointer p-2",se=()=>e.jsxs("div",{className:`
		px-4 py-2
...
`,re=()=>e.jsxs("div",{className:`
	...
	`,children:[e.jsx("h1",{className:`
		...
		bg-violet-200
		text-violet-300
	`,children:[e.jsx("div",{children:"(this is not a real site)"}),e.jsxs("div",{children:["Made with ❤️ and ",e.jsx("a",{href:"https://tailwindcss.com/",target:"_blank",className:"text-violet-400 underline",children:"Tailwind CSS"})]}),e.jsx("div",{children:"Created by User Friendly"})]}),ae=()=>e.jsxs("div",{className:"h-full min-h-[700px] flex flex-col justify-between",children:[e.jsx(se,{}),e.jsx(re,{}),e.jsx(le,{})]}),ie=({children:t})=>{let s=0;const n=[e.jsx(a,{collapse:!0,title:"Button Component Exercise",children:e.jsx(U,{})},s++),e.jsx(a,{collapse:!0,title:"Flex Exercise 1",children:e.jsx(Y,{})},s++),e.jsx(a,{collapse:!0,title:"Flex Exercise 2",children:e.jsx(X,{})},s++),e.jsx(a,{collapse:!0,title:"Analyzing Layouts",children:e.jsx(D,{})},s++),e.jsx(a,{collapse:!1,title:"Search Page Design",children:e.jsx(ae,{})},s++),e.jsx(a,{collapse:!0,title:"Click Event Exercise",children:e.jsx(P,{})},s++),e.jsx(a,{collapse:!0,title:"Conditional Rendering",children:e.jsx(z,{})},s++),e.jsx(a,{collapse:!0,title:"Counter",children:e.jsx(K,{})},s++),e.jsx(a,{collapse:!0,title:"Cat Carousel",children:e.jsx(M,{})},s++)];return e.jsxs("div",{className:"h-full flex flex-col justify-start items-strech",children:[e.jsx("h1",{className:"my-4 text-5xl self-center",children:"Modules 1, 2, & 3"}),n]})};export{ie as default};
